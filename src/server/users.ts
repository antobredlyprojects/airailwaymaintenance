...
export const SEED_USERS: SystemUser[] = [
  // ------------------ 1. FIELD OPERATIONS ------------------
  {
    ...
    current_location: "NDLS–TKJ Section, UP-125 km",
    active: true,
  ...
  },
  {
    ...
    current_location: "NDLS Division HQ",
    active: true,
  ...
  },
  {
    ...
    current_location: "NDLS Coaching Depot",
    active: true,
  ...
  },
  {
    ...
    current_location: "TKD Workshop – POH Bay 02",
    active: true,
  ...
  // ------------------ 2. PLANNING & COORDINATION ------------------
  {
    ...
    current_location: "NDLS Division – P.Way Section Office",
    active: true,
    scope: { tags: [] },
  ...
  },
  {
    ...
    current_location: "NDLS Division – C&W Office",
    active: true,
    scope: { tags: [] },
  ...
  },
  {
    ...
    current_location: "NDLS Control Room",
    active: true,
    scope: { tags: [] },
    budget_limit: null,
  ...
  // ------------------ 3. STRATEGIC & OVERSIGHT ------------------
  {
    ...
    current_location: "NDLS DRM Office",
    active: true,
    scope: { tags: [] },
  ...
  // ------------------ 4. SYSTEM ADMIN & BI ------------------
  {
    ...
    current_location: "NDLS IT Centre",
    active: true,
    scope: { tags: [] },
    budget_limit: null,
  ...
  // ------------------ 5. EXTERNAL STAKEHOLDERS ------------------
  {
    ...
    current_location: "NDLS–ALJN Section",
    active: true,
  ...
  },
  {
    ...
    current_location: "New Delhi – Inspection Cell",
    active: true,
    scope: { tags: [] },
    budget_limit: null,
